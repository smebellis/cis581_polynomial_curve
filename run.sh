...
TRAIN_FILE="$(pwd)/train.dat"
TEST_FILE="$(pwd)/test.dat"

# Run the Python script with parameters
SCRIPT_NAME="ML_learning_algo.py"
PARAMS="--train $TRAIN_FILE --test $TEST_FILE --no-plot"
...
echo "Running $SCRIPT_NAME with parameters: $PARAMS"
$REQUIRED_PYTHON "$SCRIPT_NAME" $PARAMS
